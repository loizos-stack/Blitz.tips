...
export function ContestRulesModal({
  ...
  const items = [
    ...
    "Every market we price counts: moneylines, spreads and handicaps, totals, alternate lines, 1st half / quarter / period markets, and player props. Pick them straight off the live board, or enter a pick manually if the feed doesn't carry it.",
