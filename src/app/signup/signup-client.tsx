...
function SignUpForm({ as, telegramBot }: { as: "subscriber" | "handicapper"; telegramBot: string | null }) {
...
function SignUpRouter({ telegramBot }: { telegramBot: string | null }) {
  const searchParams = useSearchParams();
  const as = searchParams.get("as");

  if (as === "subscriber" || as === "handicapper") {
    return <SignUpForm as={as} telegramBot={telegramBot} />;
  }
  return <RoleChooser />;
}

export function SignUpClient({ telegramBot }: { telegramBot: string | null }) {
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="relative">
        <Suspense fallback={null}>
          <SignUpRouter telegramBot={telegramBot} />
        </Suspense>
      </div>
    </div>
  );
