...
function SignInForm({ telegramBot }: { telegramBot: string | null }) {
      ...
      <div className="card w-full max-w-sm p-8">
        ...
        {telegramBot && (
          <div className="mt-3 flex justify-center">
            <TelegramLoginButton botUsername={telegramBot} callbackUrl={callbackUrl} onError={setError} />
          </div>
        )}
...
export function SignInClient({ telegramBot }: { telegramBot: string | null }) {
  return (
    <Suspense fallback={null}>
      <SignInForm telegramBot={telegramBot} />
    </Suspense>
  );
}
