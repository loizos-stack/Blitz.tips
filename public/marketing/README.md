...
| `supercapper-starts-1600x900.png` | 1600×900 | "Starts Sep 7" — the pre-launch push |
| `supercapper-dates-1600x900.png` | 1600×900 | Key dates, both ends, with the enter-anytime caveat |
| `supercapper-starts-square-1080.png` | 1080×1080 | "Starts Sep 7", square |
...
**September 7, 2026 → January 10, 2027** — taken from the `Contest` row's `startsAt`
and `endsAt`.
...
once ($25,000 → $10,000) and the start three times (Aug 3 → Aug 10 → Aug 16 →
Sep 7), which is exactly how these drift. Two of those start moves happened
*after* the contest had already gone live, so treat any artwork you can't date
as suspect.
